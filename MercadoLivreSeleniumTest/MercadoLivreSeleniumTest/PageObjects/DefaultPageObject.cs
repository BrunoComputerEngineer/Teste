...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        //NomeeSobreNome
        [FindsBy(How = How.XPath, Using = "/html/body/main/div[1]/div[1]/div/div/div[4]/div/section/div/form/div[1]/div/fieldset/div/div/div[1]/div[2]/div/label")]
        ...
        //CodigoDeSeguranca
        [FindsBy(How = How.XPath, Using = "//*[@id='uniqueSection']/fieldset/div/div/div[1]/div[6]/div/label")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='app - container']/div/div/div[4]/div/section/div/form/div[2]/button")]
        public IWebElement BtnContinueConfigurarCartao { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@id='app - container']/div/section/div/form/article/div/ul/li[1]/div/label/div[1]/input")]
        public IWebElement Parcelado1X { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@id='app - container']/div/section/div/div[4]/div[2]/button")]
